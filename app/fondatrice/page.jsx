  ...
  return (
    <div className='pt-24 lg:pt-44'>
      <div>
        ...
        <h1 className="text-yq_choc uppercase text-center font-montserrat mt-6 lg:mt-0 text-[10px] md:text-[13px] lg:text-[16px]">Profil personnel</h1>
      <div className='block lg:grid lg:grid-cols-2 gap-0 lg:gap-12 mt-2 lg:mt-10 px-5 lg:px-14 h-[51vh] lg:h-[85vh]'>
        <div>
          <Image src={image} width={100} height={100} alt='image' className="hidden lg:block lg:w-full lg:h-[75vh]" />
        </div>

        <div className='flex flex-col gap-3 lg:gap-4 h-[75vh]'>
          <h1 className='text-[12px] lg:text-[13px] text-yq_main mt-4 lg:mt-0 font-extralight uppercase'>Linda Mugaruka</h1>
          <p className='font-light text-[10px] md:text-[13px] lg:text-[16px] text-yq_black'>Linda Mugaruka est la fondatrice de Yetu Qahwah, une marque engagée dans la promotion du café congolais 
          ...
          <p className='font-light text-[10px] md:text-[13px] lg:text-[16px] text-yq_black'>Linda est titulaire d'un diplôme en Agronomie obtenu avec distinction, et elle continue de renforcer ses compétences
          ...
          <p className='font-light text-[10px] md:text-[13px] lg:text-[16px] text-yq_black'>Son parcours professionnel s'est construit à l'intersection de l'agriculture, de l'impact social et de 
          ...
          <p className='font-light text-[10px] md:text-[13px] lg:text-[16px] text-yq_black'>Engagée en faveur de l'autonomisation des femmes, Linda encadre et forme des femmes productrice de café, 
          ...
          <p className='font-light text-[10px] md:text-[13px] lg:text-[16px] text-yq_black'>Maman de 3 enfants, Linda est aussi une grande passionée de voyages, de gastronomie locale et de rencontres interculturelles.Elle incarne une 
            nouvelle génération de leaders africains qui croient en un développement endogène, durable et humain.</p>
        </div>
      </div>
      </div>
      
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 lg:gap-12 px-5 lg:px-14'>
        <div className='shadow-[0_4px_12px_rgba(0,0,0,0.1)] w-[98%] mx-auto lg:w-full'>
          ...
          <div className='px-4 py-6'>
             <Link target="_blank" rel="noopener noreferrer" className='text-yq_blue my-auto text-[12px] md:text-[14px] lg:text-[16px] font-light' href="https://dailycoffeenews.com/2021/09/14/three-questions-with-linda-mugaruka-the-queen-of-beans-in-the-drc/"> https://dailycoffeenews.com/2021/09/14/three-questions-with-linda-mugaruka-the-queen-of-beans-in-the-drc/</Link>
          </div>
          </div>

         <div className='shadow-[0_4px_12px_rgba(0,0,0,0.1)] w-[98%] mx-auto lg:w-full'>
          <Image src={image} width={100} height={100} alt='image' className='w-full h-[18vh] md:h-[20vh] lg:h-[25vh]' />
          <div className='px-4 py-4 lg:py-6 flex'>
            <Link target="_blank" rel="noopener noreferrer" className='text-yq_blue flex text-[12px] md:text-[14px] lg:text-[16px] font-light' href="https://www.youtube.com/watch?v=9gJUGZO_x00">https://www.youtube.com/watch?v=9gJUGZO_x00</Link>
          </div>
        </div>
         ...
         <div className='shadow-[0_4px_12px_rgba(0,0,0,0.1)] w-[98%] mx-auto lg:w-full'>
          ...
          <div className='px-4 py-4 lg:py-6'>
             <Link target="_blank" rel="noopener noreferrer" className='text-yq_blue text-[12px] md:text-[14px] lg:text-[16px] font-light' href="https://time.com/collection/next-generation-leaders/4971126/linda-mugaruka-head-next-generation-leaders/">
         ...
         <div className='shadow-[0_4px_12px_rgba(0,0,0,0.1)] w-[98%] mx-auto lg:w-full'>
          <Image src={image} width={100} height={100} alt='image' className='w-full h-[18vh] md:h-[20vh] lg:h-[25vh]'  />
          <div className='px-4 py-4 lg:py-6'>
            <Link target="_blank" rel="noopener noreferrer" className='text-yq_blue text-[12px] md:text-[14px] lg:text-[16px] font-light' href="https://www.nytimes.com/2017/08/23/world/africa/democratic-republic-congo-specialty-coffee.html">https://www.nytimes.com/2017/08/23/world/ <br /> africa/democratic-republic-congo-specialty-coffee.html</Link>
          </div>  
        </div>
        ...
        <div className='shadow-[0_4px_12px_rgba(0,0,0,0.1)] w-[98%] mx-auto lg:w-full'>
          <Image src={image} width={100} height={100} alt='image' className='w-full h-[18vh] md:h-[20vh] lg:h-[25vh]'  />
          <div className='px-4 py-4 lg:py-6'>
            <Link target="_blank" rel="noopener noreferrer" className='text-yq_blue text-[12px] md:text-[14px] lg:text-[16px] font-light' href="https://www.comunicaffe.com/fatuma-lokembo-renata-zanon-davide-spinelli-drink-congo-coffee-bwt-italia/">
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-7 lg:gap-12 mt-12 lg:mt-32 px-5 lg:px-14 h-80 lg:h-[65vh]'>
        <div className='flex flex-col gap-4 h-[57vh]'>
          ...
          <p className='font-light text-[10px] md:text-[13px] lg:text-[16px] text-yq_black'>L'autonomisation des femmes passe par l'accès au savoir, à la finance, et aux outils numériques.
          ...
          <p className='font-light text-[10px] md:text-[13px] lg:text-[16px] text-yq_black'>Chez Yetu Qahwah, nous croyons fermement en ce pouvoir de transformation. C'est pourquoi nous accompagnons les femmes 
