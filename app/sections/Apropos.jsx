...
function Apropos() {
  return (
    <section id='apropos' className='bg-yq_black pb-14'>
      <h1 className='text-center uppercase text-yq_white1 text-[16px] font-montserrat py-14'>à propos de yetu qahwah</h1>
      <div className='grid grid-cols-2'>
        <div className='flex flex-col gap-[10px] px-12'>
           <h3 className='text-[13px] text-yq_orange uppercase font-extralight'>nous avons une histoire passionnante à vous raconter</h3>
           <p className='font-light text-[16px] text-yq_white2'>
           ...
           <h3 className='text-[13px] text-yq_orange uppercase font-extralight'>à propos du café congolais</h3>
           <p className='font-light text-[16px] text-yq_white2'>Aujourd'hui, plusieurs provinces de la République Démocratique du Congo cultivent du café, notamment le Sud-Kivu,
           ...
           <h3 className='text-[13px] text-yq_orange uppercase font-extralight'>défis et moyens de les surmonter</h3>
           <p className='font-light text-[16px] text-yq_white2'>En tant que startup évoluant en République Démocratique du Congo, l'accès au financement représente un véritable défi. 
        ...
        <Image src={about} alt="about" width={100} height={100} className='w-full px-12'/>
      </div>
    </section>
  )
}
