  ...
  return (
    <section id='apropos' className='bg-yq_black pb-14'>
      <div className='flex flex-col'>
        ...
        <h1 className='text-center uppercase text-yq_white1 text-[12px] md:text-[14px] lg:text-[16px] font-semibold font-montserrat py-6 lg:py-14'>à propos de yetu qahwah</h1>
        <div className='grid grid-cols-1 lg:grid-cols-2'>
         <div className='flex flex-col gap-[10px] px-6 lg:px-12'>
           ...
           <h3 className='text-[11px] md:text-[12px] lg:text-[13px] text-yq_orange uppercase font-extralight'>à propos du café congolais</h3>
           <p className='font-light text-[14px] md:text-[15px] lg:text-[16px] text-yq_white2'>Aujourd'hui, plusieurs provinces de la République Démocratique du Congo cultivent du café, notamment le Sud-Kivu,
           ...
           <h3 className='text-[11px] md:text-[12px] lg:text-[13px] text-yq_orange uppercase font-extralight'>défis et moyens de les surmonter</h3>
           <p className='font-light text-[14px] md:text-[15px] lg:text-[16px] text-yq_white2'>En tant que startup évoluant en République Démocratique du Congo, l'accès au financement représente un véritable défi. 
