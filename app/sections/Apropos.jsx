      ...
      <div className='flex flex-col'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2'>
         <div className='flex flex-col px-6 lg:px-12'>
           ...
           <h3 className='text-[11px] md:text-[12px] lg:text-[13px] text-yq_orange uppercase font-extralight mt-4'>à propos du café congolais</h3>
           ...
           <h3 className='text-[11px] md:text-[12px] lg:text-[13px] text-yq_orange uppercase font-extralight mt-4'>défis et moyens de les surmonter</h3>
        ...
        <Image src={about} alt="about" width={100} height={100} className='hidden lg:block lg:w-[87%] lg:px-12'/>
      </div>
      </div>
    </section>
  )
