          ...
          >
            ...
            <div className='flex flex-col gap-5'>
               <div className="flex justify-between items-start gap-3 lg:gap-4">
                ...
                <p className="text-[15px] md:text-[16px] lg:text-[18px] -mt-[3px]font-montserrat text-yq_black font-medium">
                  Yetu Qahwah
                </p>
              </div>
              ...
              <div className="text-right px-1 ">
                ...
                <p className="text-yq_black text-[15px] -mt-[3px] md:text-[16px] lg:text-[18px] font-medium">
                  CDF 20,000
                </p>
              </div>
            </div>

            <button className="mt-[-12] lg:-mt-2 w-[34%] lg:w-[30%] mx-1 mb-4 lg:mb-8 px-1 py-3 border bg-yq_main border-yq_main text-yq_white1 font-medium uppercase text-[10px] md:text-[9px] lg:text-[10px] tracking-wide transition hover:bg-yq_white1 hover:text-yq_black">
              je commande
            </button>
            </div>
