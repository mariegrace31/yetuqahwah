  ...
  return (
    <section className="bg-yq_beige py-8 lg:py-16">
      <div className="flex flex-col gap-3 items-center">
        <h1 className="text-yq_main uppercase font-semibold font-montserrat text-[14px] md:text-[14px] lg:text-[18px]">
          nos services
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pt-11 pb-3 lg:pb-16 lg:pt-16 gap-7 px-7 md:px-8 lg:px-14">
        ...
        <div className="bg-yq_white1 p-4 lg:p-6 flex flex-col h-[180px] md:h-[190px] lg:h-[260px] rounded-md shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-transform duration-300 hover:-translate-y-1">
          <Image src={catering} alt="catering" width={50} height={50} className="mb-2 -ml-1 lg:mb-4 w-9 lg:w-14" />
          <h2 className="uppercase font-montserrat text-[12px] md:text-[14px] lg:text-[16px] font-medium text-left mb-2">
        ...
        <div className="bg-yq_white1 p-4 lg:p-6 flex flex-col h-[180px] md:h-[190px] lg:h-[260px] rounded-md shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-transform duration-300 hover:-translate-y-1">
          <Image src={formation} alt="formation" width={50} height={50} className="mb-2 -ml-1 lg:mb-4 w-9 lg:w-14" />
          <h2 className="uppercase font-montserrat text-[12px] md:text-[14px] lg:text-[16px] font-medium text-left mb-2">
        ...
        <div className="bg-yq_white1 p-4 lg:p-6 flex flex-col h-[180px] md:h-[190px] lg:h-[260px] rounded-md shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-transform duration-300 hover:-translate-y-1">
          <Image src={service} alt="service" width={50} height={50} className="mb-2 -ml-1 lg:mb-4 w-9 lg:w-14" />
          <h2 className="uppercase font-montserrat text-[12px] md:text-[14px] lg:text-[16px] font-medium text-left mb-2">
            service de consultant
          </h2>
          <p className="text-[12px] md:text-[13px] lg:text-[15px] text-yq_black font-light text-left flex-1 leading-relaxed">
