...
function Service() {
  return (
    <section className="bg-yq_white1 py-10 lg:py-16">
      <div className="flex flex-col gap-3 items-center">
        <h1 className="text-yq_choc uppercase font-montserrat text-[10px] md:text-[13px] lg:text-[16px]">
          nos services
        </h1>
        <p className="text-[12px] w-[80%] lg:w-full md:text-[15px] lg:text-[22px] text-yq_black text-center">
          Nos services incluent également plusieurs prestations pensées pour vous accompagner.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-12 lg:py-16 gap-7 px-7 md:px-8 lg:px-14">
       
        <div className="bg-yq_white1 p-4 lg:p-6 flex flex-col h-[180px] md:h-[190px] lg:h-[255px] rounded-md shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-transform duration-300 hover:-translate-y-1">
