...
function Hero() {
  return (
    <section
      id="acceuil"
      className="relative w-full h-[120vh] lg:h-[108vh] flex items-center"
    >
      <Image
        src={coffeecup}
        alt="Hero Image"
        fill
        priority
        className="object-cover object-[45%_center] lg:object-[1%_center]"
      />
      ...
      <div className="relative z-10 max-w-2xl px-5 md:px-9 lg:px-14 -translate-y-20  md:translate-y-0">
        ...
        <p className="mt-4 lg:mt-6 text-yq_black font-light font-sans w-[50%] lg:w-[100%] text-[13px] md:text-[12px] lg:text-[15px] leading-relaxed">
