  ...
  return (
    ...
    >
      <Image
        ...
        fill
        priority
        className="object-cover object-[28%_center] lg:w-full lg:object-[20%_center]"
      />

      <div className="absolute inset-0"></div>

      <div className="relative z-10 max-w-2xl px-5 md:px-9 lg:px-14">
        <h1 className="uppercase text-[20px] md:text-[25px] lg:text-[38px] w-[70%] lg:w-[100%] font-montserrat leading-7 lg:leading-[45px] font-black text-yq_choc">
        ...
        <div className="mt-5 lg:mt-8 flex gap-4 lg:gap-6">
          ...
          <button className="px-4 lg:px-6 py-2 bg-yq_white1 lg:py-3 border border-yq_main text-yq_main uppercase text-[10px] md:text-[11px] lg:text-[13px] tracking-wide transition hover:bg-yq_lightbeige">
            en savoir plus
          </button>
        </div>
      </div>
