  ...
  return (
    ...
    >
      <Image
        ...
        fill
        priority
        className="object-cover object-[59%_center] md:object-center"
      />

      <div className="absolute inset-0"></div>

      <div className="relative z-10 max-w-2xl px-5 md:px-9 lg:px-14">
        <h1 className="uppercase text-[20px] md:text-[25px] lg:text-[38px] w-[70%] lg:w-[100%] font-montserrat leading-relaxed font-bold text-yq_choc">
